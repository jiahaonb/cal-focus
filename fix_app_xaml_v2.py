        ...
        <ResourceDictionary>
            ...
            <ResourceDictionary.ThemeDictionaries>
                ...
                <ResourceDictionary x:Key="Dark">
                    <Color x:Key="AppBrandColor">#10B981</Color>
                    <Color x:Key="AppBackgroundColor">#111827</Color>
                    <Color x:Key="AppCardColor">#1F2937</Color>
                    <Color x:Key="AppTextColor">#F3F4F6</Color>
                    <Color x:Key="AppMutedColor">#9CA3AF</Color>
                    <Color x:Key="AppBorderColor">#374151</Color>
                    <Color x:Key="AppTitleColor">#F9FAFB</Color>
                    <Color x:Key="AppHoverColor">#374151</Color>
